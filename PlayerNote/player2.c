...
//像素格式：YUV的数据
  ...
  //图像裁剪
  sws_ctx = sws_getContext(pCodecCtx->width,//原始宽
			   pCodecCtx->height,//原始高
			   pCodecCtx->pix_fmt,
			   pCodecCtx->width,//输出宽
			   pCodecCtx->height,//输出高
			   AV_PIX_FMT_YUV420P,
			   SWS_BILINEAR,
			   NULL,
			   NULL,
